...
import { Flex, Button, Image ,useMediaQuery,
...
const Index = ({backgroundColor}) => {
  ...
  return (
    <Flex bg={backgroundColor} w="100%" h="60px" justify="center" borderBottom="1px solid #00000014" position='fixed' zIndex={100}>
      <Flex w={isGreaterThan1000 ? '80%' : "95%"} justify="space-between" alignItems="center">
        ...
        <Flex alignItems='center' gap='10px' w='100%' justify='end'>
           ...
           <a href="https://www.influcent.com/"
           target="_blank"
           >

<Button fontSize="14px" fontWeight="500" width="165px" height="40px" border="1px solid #00000033" fontFamily="Inter"  borderRadius="5px"
bgColor="white"
          _hover="none"
...
<a href="https://www.influcent.com/contact">
         <Button   w="110px" flexShrink={1}  bgColor="#171716" color="white"   fontWeight='600' fontSize='14px' h='40px' borderRadius="5px"
